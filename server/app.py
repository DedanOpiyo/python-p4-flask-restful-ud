...
class NewsletterByID(Resource):
    ...
    def patch(self, id):
        ...
        newsletter = Newsletter.query.filter_by(id=id).first() # .to_dict() # don't turn into a dict yet, setattr() will fail

        # # Option 1: Using raw -> JSON
        ...
        # db.session.add(newsletter) # Optional
        db.session.commit()
